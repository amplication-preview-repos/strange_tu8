...
import { LandingPage } from "../../landingPage/base/LandingPage";
...
export class CourseResolverBase {
  ...
  async createCourse(@graphql.Args() args: CreateCourseArgs): Promise<Course> {
    return await this.service.createCourse({
      ...
      data: {
        ...
        landingPage: args.data.landingPage
          ? {
              connect: args.data.landingPage,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => LandingPage, {
    nullable: true,
    name: "landingPage",
  })
  async getLandingPage(
    ...
    const result = await this.service.getLandingPage(parent.id);
